error id: file://<WORKSPACE>/spark_example/src/main/scala/org/uma/jmetalsp/spark/examples/campaign/SimpleCampaignOptimizer.scala:org/uma/jmetalsp/spark/examples/campaign/CustomerAssignment#channel.
file://<WORKSPACE>/spark_example/src/main/scala/org/uma/jmetalsp/spark/examples/campaign/SimpleCampaignOptimizer.scala
empty definition using pc, found symbol in pc: org/uma/jmetalsp/spark/examples/campaign/CustomerAssignment#channel.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -scala/collection/JavaConverters.assignment.channel.
	 -scala/collection/JavaConverters.assignment.channel#
	 -scala/collection/JavaConverters.assignment.channel().
	 -assignment/channel.
	 -assignment/channel#
	 -assignment/channel().
	 -scala/Predef.assignment.channel.
	 -scala/Predef.assignment.channel#
	 -scala/Predef.assignment.channel().
offset: 7660
...
object SimpleCampaignOptimizer {
  ...
  private def printScheduleDetails(solution: DoubleSolution, problem: CampaignSchedulingProblem, label: String): Unit = {
    ...
    sortedAssignments.take(15).foreach { assignment =>
      val channelName = assignment.cha@@nnel match {
        case 0 => "Email"
        case 1 => "SMS"
        case 2 => "Push"
        case 3 => "In-app"
  ...
  private def saveScheduleAsParquetSimple(
    ...
    try {
      ...
      val hdfsPath = s"/campaign_optimization/simple_schedule_${filename}"
